...
1. A table containing the information shown above - in a real world example, this data would be coming in from a database, fetched by backend API’s. For the purposes of this project, I have stored this data in an appropriate data structure.
